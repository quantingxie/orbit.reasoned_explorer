...
from orbit.reasoned_explorer.config import (
    ReasonedExplorerCarlaCfg,
)
from orbit.reasoned_explorer.reasoned_explorer import ReasonedExplorerAlgo
...
def main():
    ...
    reasonedexplorer = ReasonedExplorerAlgo(model_dir=args_cli.model_dir)
